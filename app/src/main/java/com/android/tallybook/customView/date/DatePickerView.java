package com.android.tallybook.customView.date;
...
public class DatePickerView extends View {
    ...
    private final WeakHandler updateHandler = new WeakHandler(new Handler.Callback() {
        @Override
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.green_1));
        //第二个paint
    ...
    class MyTimerTask extends TimerTask {
        ...
        public MyTimerTask(WeakHandler handler) {
